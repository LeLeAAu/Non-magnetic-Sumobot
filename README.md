...
* [cite_start]**Sàn đấu "trơn trượt":** Sàn tròn đường kính 100cm, có viền trắng 5cm. Đặc biệt, sàn không có kim loại, do đó không thể sử dụng nam châm để tăng ma sát ép mặt đường.
* [cite_start]**Luật 3 giây:** Bot phải có đoạn chương trình chờ 3 giây trước khi bắt đầu di chuyển.
* [cite_start]**Giao chiến:** Đẩy đối thủ ra ngoài hoặc làm đối thủ lật ngã là thắng.
* * [cite_start]**Giới hạn khối lượng":** m_max = 1.5kg.
...
* **Năng lượng:** 3 cell pin 18650 tạo nguồn 3S (~11.1V) cấp dòng trực tiếp cho động cơ. Sử dụng module giảm áp LM2596 Buck (hạ từ 12V xuống 7V) để nuôi Arduino và cảm biến. *Lưu ý: Hệ thống chạy trực tiếp không qua mạch bảo vệ BMS*.
...
Tuy nhiên, **thực tế chiến trường luôn khắc nghiệt**: Các cảm biến IR biên đã hoàn toàn "tịt ngòi" khi thi đấu thực tế. Do đó, mã nguồn chính thức được sử dụng là một bản *Fallback* hoàn toàn dựa vào sóng siêu âm (File: `Nếu cảm biến IR biên không hoạt động - 4IR + 4US.ino`).
